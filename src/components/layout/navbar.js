    ...
    <nav className="bg-white shadow nav-transparent">
      <div className="container mx-auto px-8 py-3 ">
        <div className="md:flex md:items-center md:justify-between">
          ...
          <div id="navbar-nav" className={`${ isExpanded ? `block` : `hidden` } ml-auto navbar-nav nav-pills -mx-4 sm:justify-end md:flex md:items-center w-full block flex-grow lg:flex lg:items-center justify-end lg:w-auto`}>
